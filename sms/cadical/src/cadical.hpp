...
public:
  ...
  bool traverse_all_clauses (ExtendedClauseIterator &) const; // including redundant clauses
...
// Same as 'ClauseIterator' but also allows to traverse redundant clauses.
class ExtendedClauseIterator : public ClauseIterator {
public:
  virtual ~ExtendedClauseIterator () {}
  virtual bool clause (const std::vector<int> &, bool redundant) = 0;
  virtual bool clause (const std::vector<int> &) = 0;
};
